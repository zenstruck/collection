...
namespace Zenstruck\Collection\Tests\Bridge\Pagerfanta;

use Pagerfanta\Pagerfanta;
use PHPUnit\Framework\TestCase;
use Zenstruck\Collection\Bridge\Pagerfanta\CollectionAdapter;
...
final class CollectionAdapterTest extends TestCase
{
    ...
    {
        $pagerfanta = new Pagerfanta(new CollectionAdapter(new IterableCollection([1, 2, 3, 4])));
